...
export class IconStrokedButtonDirective {
  ...
  readonly classes = computed(() => {
    const baseClasses = 'flex items-center justify-center relative rounded-lg border tracking-wide transition-all duration-200 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 [&_base-icon]:stroke-current [&_base-icon]:fill-current';
