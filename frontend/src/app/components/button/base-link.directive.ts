...
export class BaseLinkDirective {
  ...
  readonly classes = computed(() => {
    const baseClasses = 'inline-flex items-center tracking-wide transition-colors duration-200 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-disabled:pointer-events-none [&_base-icon]:stroke-current [&_base-icon]:fill-current';
